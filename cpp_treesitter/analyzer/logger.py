...
# 为了向后兼容，提供Logger类的别名和静态方法
class Logger:
    """Logger类，提供静态方法接口"""
    
    @staticmethod
    def setup_logger(log_file: str = None, verbose: bool = False):
        """设置全局日志器"""
        global _global_logger
        console_level = "DEBUG" if verbose else "INFO"
        _global_logger = CppAnalyzerLogger(log_file=log_file, console_level=console_level)
